...
@section('developer.permissions.add', 'active')

@section('breadcrumb')
    @include('back.partials.breadcrumb',['title' => 'Sistema de Compras', 'active' => 'Crear Permiso', 'breadcrumb' => []])
@endsection
            ...
            <div class="ibox-title">
                ...
                <div class="row">
                    <div class="ibox-content">
                        <form action="{{route('back.security.permission.create')}}" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return checkSubmit();">
